<div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top" data-spy="affix" role="navigation" style="margin-bottom: 0">
 ...
 <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Cristiano Santos de Souza <b class="caret"></b></a>
