            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu message-dropdown">
                        <?php
                        $sql = mysqli_query($conexao,"SELECT nome,email,data,menssagem FROM resp ");

                        while($valor = mysqli_fetch_array($sql)) {
                            //if ($valor['email'] == $_SESSION['email']){
                            ?>
                                ...
                                <a href="#">
                                    ...
                                    <span class="pull-left">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading"><strong><?=$valor["nome"]?></strong>
                                            </h5>

                                            <p class="small text-muted"><i class="fa fa-clock-o"></i> <?=$valor["data"]?>
                                            </p>
    ...
    <!-- /. NAV SIDE  -->
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><strong>CURSO DE SEGURANÇA TRABALHO COM ELETRICIDADE (NR-10)</strong></h2>
                        <h5><?php echo "Bem vindo <strong>". $_SESSION['nome'] ."</strong>, ao curso de NR-10. "?></h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                 <hr />
                 <div class="row">
                    ...
                    <div class="panel panel-default">
						...
						<iframe src="//www.slideshare.net/slideshow/embed_code/key/8apkB8W8Pz032L" width="980" height="485" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> </iframe></div>
                            <iframe width="980" width="560" height="551" height="315" src="https://www.youtube.com/embed/tZiAapocj7E" frameborder="0" allowfullscreen></iframe>
                            <br>
                            <br>
                            <br>
                            <br>
                            <p>NR-10 é a Norma Regulamentadora emitida pelo Ministério do Trabalho e Emprego do Brasil que tem por objetivo garantir a segurança e a saúde dos trabalhadores que interagem com instalações e serviços em eletricidade.</p>
        ...
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p><a href="https://docente.ifsc.edu.br/felipe.camargo/MaterialDidatico/MECA%201%20-%20SEG.%20DO%20AMB.%20E%20DO%20TRAB./Material%20de%20apoio/Apostila%20NR-10.pdf" target="_blank" style="color: #000""><i class="fa fa-file-pdf-o fa-2x"></i> Aportila Fundamentos de NR-10</a></p>
                </div>
            </div>
